...
func _build_children() -> void:
	...
	_move_btn = _make_button("Move", MT.ACCENT_SECONDARY)
	...
	_attack_btn = _make_button("Attack", MT.ACCENT_DANGER)
	...
	_tame_btn = _make_button("Tame", MT.ACCENT_SUCCESS)
...
func _make_button(label_text: String, accent: Color) -> Button:
	var btn := UH.make_button(label_text, "primary")
